...
class Vector3 {
    ...
    magnitude() {
        ...
        m += this.elements[0]*this.elements[0]; 
        m += this.elements[1]*this.elements[1];
        m += this.elements[2]*this.elements[2];  
        m = Math.sqrt(m);
        // Don't delete the return statement.
        return m;
    };
    ...
    normalize() {
        ...
        this.elements[0] = this.elements[0] / ma;
        this.elements[1] = this.elements[1] / ma;
        this.elements[2] = this.elements[2] / ma;
        // Don't delete the return statement.
        return this;
    };
}
